 ...
 * This section should be at line no 13-21
 */
define('ROOT_URL', 'http://localhost/modernpos/');
...
define('DIR_SRC', DIR_INCLUDE.'/src/');
 ...
 */
define('FILEMANAGERURL', ROOT_URL.'storage/products');
...
/*
 * --------------------------------------------------------------------
 * ALLOWED THESE IPs ONLY, IF EMPTY THEN ALLOWS ALL IPs
 * --------------------------------------------------------------------
 */
 ...
 * --------------------------------------------------------------------
 *
 * If true then system will use completed assets, i.e. minified/combined js, css and images
 */
define('USECOMPILEDASSET', false); // Set to false to use original source files instead of minified versions

/*
 * --------------------------------------------------------------------
 * Right to Left (RTL) Toggling 12-MAY-2025
 * --------------------------------------------------------------------
 *
 * If true then system will use completed assets, i.e. minified/combined js, css and images
 */
