...
<head>
    ...
    <title><?php echo trans('text_site_maintainance'); ?></title>
...
<body>
    <section id="wrapper">
        <h1><?php echo trans('text_resetting'); ?></h1>
        <div id="content">
            <p><?php echo trans('text_resetting_info'); ?></p>
            <p>&mdash; <a target="_blink" href="<?php echo trans('text_footer_link'); ?>" title="<?php echo trans('text_footer_link_text'); ?>"><?php echo trans('text_footer_link_text'); ?></a></p>
        </div>
    </section>
</body>
</html>