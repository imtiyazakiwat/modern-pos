window.angularApp.controller("PosController", [
    ...
    function (
        ...
        $scope.payNow = function () {
            console.log('[PosController] payNow called');
            ...
            console.log('[PosController] Opening payment modal for customer:', $scope.customerId);
            ...
            setTimeout(function () {
                try {
                    console.log('[PosController] Calling PaymentFormModal');
                    PaymentFormModal($scope);
                } catch (error) {
                    console.error('[PosController] Error opening payment modal:', error);
                    $('body').removeClass('overlay-loader');
                    $('.modal').removeClass('overlay-loader');
                    window.toastr.error("Failed to open payment modal. Please try again.", "Error!");
                }
            }, 300);
        }
