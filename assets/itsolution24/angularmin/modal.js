        ...
        var uibModalInstance = $uibModal.open({
            ...
            template: "<div class=\"modal-header\">" +
                        ...
                        "<div class=\"modal-footer\">" +
                            ...
                            "<button  ng-click=\"payNow('No');\" type=\"button\" class=\"btn btn-success radius-50\"><i class=\"fa fa-fw fa-money\"></i> Pay Now &rarr;</button>" +
                        "</div>",
            controller: function ($scope, $uibModalInstance) {
                ...
                $scope.payNow = function(fullPayment) {
                    $(document).find(".modal").addClass("overlay-loader");
                    var form = $("#checkout-form");
                    var data = form.serialize();
                    $http({
                        url: window.baseUrl+"_inc/payment.php?action_type=PAYMENT&full_payment=" + fullPayment,
                        method: "POST",
                        data: data,
                        cache: false,
                        processData: false,
