...
class SpreadsheetReader_XLSX implements Iterator, Countable
{
	...
	/**
	 * @var string $Handle Handle for the reader object
	 */
	 ...
	 *
	 * @return bool current element from the collection
	 */
	#[ReturnTypeWillChange]
	 ...
	 *
	 * @return false|float|int Numeric index (0-based) or boolean false if it cannot be calculated
	 */
