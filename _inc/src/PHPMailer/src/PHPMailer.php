...
class PHPMailer
{
    ...
    protected function generateId()
    {
        ...
        return str_replace(['=', '+', '/'], '', encode_data(hash('sha256', $bytes, true)));
    }
    ...
    public function DKIM_Add($headers_line, $subject, $body)
    {
        ...
        $DKIMb64 = encode_data(pack('H*', hash('sha256', $body)));
        $ident = '';
