...
abstract class ExceptionCatcher
{
     ...
     * @return string
     */
    protected static function getHighlightedCode(array $trace, $showLineNumber = false)
    {
        $content = '';
     ...
     * @return array
     */
    protected static function buildDetails(Exception $oExp)
    {
        $arr = array();
     ...
     * @return array
     */
    protected static function getDetails($file, $line)
    {
