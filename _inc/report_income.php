...
GROUP_CONCAT(DISTINCT income_sources.source_slug) AS source_slug, GROUP_CONCAT(DISTINCT income_sources.profitable) AS profitable, GROUP_CONCAT(DISTINCT bank_transaction_price.price_id) AS price_id, SUM(bank_transaction_price.amount) amount 
