...
GROUP_CONCAT(DISTINCT purchase_item.id) AS id, GROUP_CONCAT(DISTINCT purchase_item.item_id) AS item_id, GROUP_CONCAT(DISTINCT purchase_item.item_name) AS item_name, GROUP_CONCAT(DISTINCT purchase_item.item_quantity) AS item_quantity,
