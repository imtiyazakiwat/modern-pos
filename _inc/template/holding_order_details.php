		...
		<div class="col-lg-4 col-md-4 col-sm-5 col-xs-6 bootboox-container table-holding-order">
			...
			<ul class="list-group">
				<li id="holding-order-item-{{ order.ref_no }}" class="list-group-item holding-order-item" ng-repeat="order in orders | filter:search">
					<div style="<?php echo !isset($dynamic_css) ? 'display:table;width:100%;' : '';?>">
						<div class="table-row">
							<div class="table-cell" style="<?php echo !isset($dynamic_css) ? 'display:table-cell;vertical-align:middle;' : '';?>">
							...
							<div class="table-cell text-right" style="<?php echo !isset($dynamic_css) ? 'display:table-cell;vertical-align:middle' : '';?>">
								<span ng-click="deleteHoldingOrder(order.ref_no);" class="fa fa-trash text-red pointer" title="Delete"></span>
							</div>
						</div>
					</div>
				</li>
