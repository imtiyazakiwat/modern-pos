  ...
  <div class="box-body">
    ...
    <div class="form-group">
      <label for="code" class="col-sm-4 control-label">
        ...
        <span data-toggle="tooltip" title="" data-original-title="<?php echo trans('hint_code'); ?>"></span>
      </label>
      <div class="col-sm-6">
    ...
    <div class="form-group">
      <label for="store_select" class="col-sm-4 control-label">
        <?php echo trans('label_store'); ?><i class="required">*</i>
      </label>
      <div class="col-sm-6 store-selector">
        <div class="checkbox selector">
          <label>
            <input id="store_select" type="checkbox" onclick="$('input[name*=\'currency_store\']').prop('checked', this.checked);"> Select / Deselect
          </label>
        </div>
