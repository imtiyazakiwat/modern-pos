<div class="table-responsive">
  ...
  <table class="table table-striped table-condenced">
    <tbody>  
      ...
      <tr>
        ...
        <td class="text-center danger">
          <h4><?php echo trans('text_substract_amount'); ?> <small>(<?php echo trans('text_for_sell_return'); ?>)</small></h4>
          <h2 class="price">
  ...
  <h4 class="text-center"><b><?php echo trans('text_purchase_tax'); ?> (<?php echo trans('text_gst'); ?>)</b></h4>
  <table class="table table-striped table-condenced">
    <tbody>  
      <tr>
        <td class="text-center bg-info">
