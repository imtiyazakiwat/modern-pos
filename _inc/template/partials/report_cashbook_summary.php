<div class="table-responsive">
  <table class="table table-bordered table-striped mb-0">
    <tbody>
      ...
      <tr>
        <td class="w-50 bg-gray text-right">
           <a class="text-black" href="income_monthwise.php?date=<?php echo date('Y-m-d',strtotime($from));?>" title="<?php echo trans('button_details'); ?>">
      ...
      <tr class="bg-red">
        <td class="w-50 text-right">
          <a class="t-white" href="expense_monthwise.php?date=<?php echo date('Y-m-d',strtotime($from));?>" title="<?php echo trans('button_details'); ?>">
            <span class="fa fa-link"></span>
          </a>
