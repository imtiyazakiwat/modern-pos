<div class="progress-group-container">
  ...
  <div class="progress-group">
    ...
    <div class="progress sm">
      <div class="progress-bar progress-bar-warning" style="width:<?php echo $discount_amount > 0 ? ($discount_amount/$invoice_amount)*100 : 0;?>%"></div>
    </div>
  </div>
  <div class="progress-group">
    ...
    <div class="progress sm">
      <div class="progress-bar progress-bar-red" style="width: <?php echo $due_amount > 0 ? ($due_amount/$invoice_amount)*100 : 0;?>%"></div>
    </div>
  </div>
  <div class="progress-group">
    ...
    <div class="progress sm">
      <div class="progress-bar progress-bar-success" style="width: <?php echo $received_amount > 0 ? ($received_amount/$invoice_amount)*100 : 0;?>%"></div>
    </div>
  </div>
