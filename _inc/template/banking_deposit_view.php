					...
					<tr>
						...
						<td class="w-70">
							<?php if (isset($invoice['image']) && ((FILEMANAGERPATH && is_file(FILEMANAGERPATH.$invoice['image']) && file_exists(FILEMANAGERPATH.$invoice['image'])) || (is_file(DIR_STORAGE . 'products' . $invoice['image']) && file_exists(DIR_STORAGE . 'products' . $invoice['image'])))) : ?>
				              <a target="_blink" href="<?php echo FILEMANAGERURL ? FILEMANAGERURL : root_url().'storage/products'; ?>/<?php echo $invoice['image']; ?>"><img  src="<?php echo FILEMANAGERURL ? FILEMANAGERURL : root_url().'storage/products'; ?>/<?php echo $invoice['image']; ?>" width="40" height="50" alt="product image"></a>
				            <?php endif; ?>
						</td>
					</tr>
					<tr>
