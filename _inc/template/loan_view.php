        ...
        <tr>
          ...
          <td class="w-70">
            <?php if (isset($loan['attachment']) && ((FILEMANAGERPATH && is_file(FILEMANAGERPATH.$loan['attachment']) && file_exists(FILEMANAGERPATH.$loan['attachment'])) || (is_file(DIR_STORAGE . 'products' . $loan['attachment']) && file_exists(DIR_STORAGE . 'products' . $loan['attachment'])))) : ?>
                    <a target="_blink" href="<?php echo FILEMANAGERURL ? FILEMANAGERURL : root_url().'storage/products'; ?>/<?php echo $loan['attachment']; ?>"><img  src="<?php echo FILEMANAGERURL ? FILEMANAGERURL : root_url().'storage/products'; ?>/<?php echo $loan['attachment']; ?>" width="40" height="50" alt="attachment image"></a>
                  <?php endif; ?>
          </td>
        </tr>
        <tr class="bg-gray">
