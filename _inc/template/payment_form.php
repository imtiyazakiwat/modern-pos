...
?>
<form class="form-horizontal" id="checkout-form" action="place_order.php" data-redirect="view_invoice.php">
...
<input type="hidden" name="redirect-page" value="view_invoice.php"> <!-- Explicit redirect target -->
