...
<div id="quotataion-view">
	<div class="logo" style="<?php echo !isset($dynamic_css) ? 'text-align:center;margin-bottom:10px;' : '';?>">
	...
	<table class="table table-bordered">
		<tbody>
			<tr>
				<td style="<?php echo !isset($dynamic_css) ? 'width:50%;vertical-align:top;' : '';?>">
					<h6 style="<?php echo !isset($dynamic_css) ? 'font-style:italic;font-weight:bold;' : '';?>"><?php echo trans('label_from');?>:</h6>
					<address>
						<h4 style="<?php echo !isset($dynamic_css) ? 'font-weight:bold;' : '';?>"><?php echo store('name');?></h4>
				...
				<td style="<?php echo !isset($dynamic_css) ? 'width:50%;vertical-align:top;' : '';?>">
					<h6 style="<?php echo !isset($dynamic_css) ? 'font-style:italic;font-weight:bold;' : '';?>"><?php echo trans('label_to');?>:</h6>
					<address>
						<h4 style="<?php echo !isset($dynamic_css) ? 'font-weight:bold;' : '';?>"><?php echo $customer_name;?></h4>
		...
		<div class="col-md-12">
			<div class="table-responsive">
				<table class="table table-bordered margin-b0">
					<thead>
					<tr class="bg-gray">
						<td class="w-5" style="<?php echo !isset($dynamic_css) ? 'background:#f4f4f4;' : '';?>">
							<?php echo trans('label_serial_no'); ?>	
						</td>
						<td class="w-35" style="<?php echo !isset($dynamic_css) ? 'background:#f4f4f4;' : '';?>">
							<?php echo trans('label_product'); ?>	
						</td>
						<td class="w-20 text-right" style="<?php echo !isset($dynamic_css) ? 'background:#f4f4f4;' : '';?>">
							<?php echo trans('label_unit_price'); ?>
						</td>
						<td class="w-15 text-right" style="<?php echo !isset($dynamic_css) ? 'background:#f4f4f4;' : '';?>">
							<?php echo trans('label_item_tax'); ?>
						</td>
						<td class="w-25 text-right" style="<?php echo !isset($dynamic_css) ? 'background:#f4f4f4;' : '';?>">
					...
					<tfoot>
						...
						<tr class="bg-gray">
							<td class="text-right" colspan="4" style="<?php echo !isset($dynamic_css) ? 'font-weight:bold;' : '';?>">
								<?php echo trans('label_total_amount'); ?>
							</td>
							<td class="w-20 text-right" style="<?php echo !isset($dynamic_css) ? 'font-weight:bold' : '';?>">
			...
			<table class="table margin-b0" style="<?php echo !isset($dynamic_css) ? 'margin-top:100px;' : '';?>">
				<tr>
					<td class="w-25" style="<?php echo !isset($dynamic_css) ? 'text-align:center;border:0;' : '';?>"></td>
					<td class="w-25" style="<?php echo !isset($dynamic_css) ? 'text-align:center;border:0;' : '';?>"></td>
					<td style="<?php echo !isset($dynamic_css) ? 'text-align:center;border:0;' : '';?>">
						<hr>
