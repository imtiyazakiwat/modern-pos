    ...
    <div class="nav-tabs-custom">
      ...
      <div class="tab-content">
                ...
                <td class="text-center">
                  <div class="image-thumbnail">
                    <a class="open-filemanager" data-imageid="{{img.id}}" data-toggle="image" id="thumb{{img.id}}" href="#">
                      <img ng-show="img.url" ng-src="<?php echo FILEMANAGERURL;?>{{ img.url }}" alt="no image">
                      <img ng-show="!img.url" src="../assets/itsolution24/img/noimage.jpg" alt="no image">
                    </a>
                  </div>
                </td>
                <td>
        ...
        <div class="tab-pane<?php echo $tab_active == 'general' ? ' active' : null;?>" id="general">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-8 store-selector">
              <div class="checkbox selector">
                <label>
                  <input id="store_select" type="checkbox" onclick="$('input[name*=\'product_store\']').prop('checked', this.checked);"> Select / Deselect
                </label>
              </div>
          ...
          <div class="form-group">
            <label for="edit_description" class="col-sm-3 control-label">
