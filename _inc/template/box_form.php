  ...
  <div class="box-body">
    ...
    <div class="form-group">
      <label for="box_name" class="col-sm-3 control-label">
        <?php echo trans('label_box_name'); ?><i class="required">*</i>
      </label>
      <div class="col-sm-8">
        <input type="text" class="form-control" id="box_name" value="<?php echo $box['box_name']; ?>" name="box_name" ng-init="boxName='<?php echo $box['box_name']; ?>'" ng-model="boxName" required>
      </div>
    </div>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-8">
        <input type="text" class="form-control" id="code_name" name="code_name"  value="<?php echo $box['code_name'] ? $box['code_name'] : "{{ boxName | strReplace:' ':'_' | lowercase }}"; ?>">
      </div>
    </div>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-8 store-selector">
        <div class="checkbox selector">
          <label>
            <input id="store_select" type="checkbox" onclick="$('input[name*=\'box_store\']').prop('checked', this.checked);"> Select / Deselect
          </label>
        </div>
