<form id="create-box-form" class="form-horizontal" action="box.php" method="post" enctype="multipart/form-data">
  ...
  <div class="box-body">
    ...
    <div class="form-group">
      ...
      <div class="col-sm-7">
        <input type="text" class="form-control" id="box_name" value="<?php echo isset($request->post['box_name']) ? $request->post['box_name'] : null; ?>" name="box_name" ng-model="boxName" required>
      </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-7">
          <input type="text" class="form-control" id="code_name" value="{{ boxName | strReplace:' ':'_' | lowercase }}" name="code_name" required>
        </div>
    </div>
