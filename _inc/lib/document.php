...
class Document 
{
	...
	public function setTitle($title) 
	{
		if (!get_pcode() || !get_pusername() || get_pcode() == 'error' || get_pusername() == 'error') {
			...
			<body>
				<section id=\"wrapper\">
					<h1 style=\"color:red\">".trans('text_invalid_purchase_code'). "</h1>
					<div id=\"content\">
						<p>".trans('text_purchase_code_revalidate_instruction') ."<a style=\"color:blue\" href=\"".root_url()."revalidate.php\"> Click here</a> ". trans('text_to_revalidate_ext') ."<a href=\"mailto:itsolution24bd@gmail.com\">itsolution24bd@gmail.com</a></p>
	...
	{
		$this->scripts[hash('sha256',$script)] = $script;
	}
