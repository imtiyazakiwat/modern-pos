...
if(isset($request->get['action']) && $request->get['action'] == 'DELETE_CSV') 
{
	$path = DIR_STORAGE.'products/stock-'.store_id().'.csv';
	if (file_exists($path)) {
		unlink($path);
	}
	redirect(root_url().ADMINDIRNAME.'/purchase.php?box_state=open');
}
        ...
        <div class="box box-success">
          <div class="box-header">
            ...
            <div class="box-tools pull-right">
              <a id="pay-all" class="btn btn-success" href="#" title="<?php echo trans('button_pay_all');?>"><span class="fa fa-fw fa-money"></span> <?php echo trans('button_pay_all');?></a>
              <div class="btn-group">
