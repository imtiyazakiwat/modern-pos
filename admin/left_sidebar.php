  ...
  <section class="sidebar">
    ...
    <ul class="sidebar-menu">
      ...
      <?php if (user_group_id() == 1 || has_permission('access', 'read_purchase_list') || has_permission('access', 'create_purchase_invoice') || has_permission('access', 'read_purchase_return') || has_permission('access', 'read_purchase_log')) : ?>
        <li class="treeview<?php echo current_nav() == 'purchase' || current_nav() == 'purchase_return' || current_nav() == 'purchase_log' || current_nav() == 'import_stock' ? ' active' : null; ?>">
          ...
          <ul class="treeview-menu">
            ...
            <?php endif; ?>
            <?php if (user_group_id() == 1 || has_permission('access', 'import_stock')): ?>
              <li class="<?php echo current_nav() == 'import_stock' ? ' active' : null; ?>">
                <a href="import_stock.php">
                  <svg class="svg-icon"><use href="#icon-import"></svg>
                  <?php echo trans('menu_stock_import'); ?>
                </a>
              </li>
            <?php endif; ?>
          </ul>
