...
<html lang="<?php echo $document->langTag($active_lang);?>" <?php echo !isset($angular_disabled) ? 'ng-app="angularApp"' : null; ?>>
  <head>
    ...
    <?php if (DEMO || USECOMPILEDASSET) : ?>
        ...
        <link type="text/css" href="../assets/itsolution24/cssmin/main<?php echo isRTL() ? '-rtl' : null;?>.css" rel="stylesheet">
    ...
    <!-- Plugin CSS -->
        ...
        <!-- Bootstrap CSS -->
        <link type="text/css" href="../assets/bootstrap/css/bootstrap<?php echo isRTL() ? '-rtl' : null;?>.min.css" rel="stylesheet">
        ...
        <!-- Morris CSS -->
        <link type="text/css" href="../assets/morris/morris.css" rel="stylesheet">

        <!-- Select2 CSS -->
        <link type="text/css" href="../assets/select2/select2.min.css" rel="stylesheet">

        <!-- Datepicker3 CSS-->
        <link type="text/css" href="../assets/datepicker/datepicker3.css" rel="stylesheet">

        <!-- Bootstrap Timepicker CSS -->
        <link type="text/css" href="../assets/timepicker/bootstrap-timepicker.min.css" rel="stylesheet">

        <!-- Bootstrap3 Wysihtml5 CSS -->
        <link type="text/css" href="../assets/bootstrap-wysihtml5/bootstrap3-wysihtml5.min.css" rel="stylesheet">
        ...
        <link type="text/css" href="../assets/itsolution24/css/filemanager/dialogs.css" rel="stylesheet">

        <!-- Filemanager Main CSS -->
        <link type="text/css" href="../assets/itsolution24/css/filemanager/main.css" rel="stylesheet">

    <!-- Theme CSS -->
        <link type="text/css" href="../assets/itsolution24/css/theme.css" rel="stylesheet">

        <!-- Skin Black CSS -->
        <link type="text/css" href="../assets/itsolution24/css/skins/skin-black.css" rel="stylesheet">

        <!-- Skin Blue CSS -->
        <link type="text/css" href="../assets/itsolution24/css/skins/skin-blue.css" rel="stylesheet">

        <!-- Skin Green CSS-->
        <link type="text/css" href="../assets/itsolution24/css/skins/skin-green.css" rel="stylesheet">

        <!-- Skin Red CSS -->
        <link type="text/css" href="../assets/itsolution24/css/skins/skin-red.css" rel="stylesheet">

        <!-- Skin Yellow CSS -->
        <link type="text/css" href="../assets/itsolution24/css/skins/skin-yellow.css" rel="stylesheet">
