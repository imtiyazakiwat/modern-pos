            ...
            <div class="row">
              <div class="pr-15 col-md-6 col-xs-12">
                <div class="box box-default banking-box">
                  ...
                  <div class="box-body">
                    <div class="table-responsive min-h150">
                          ...
                          <?php if ($transactions = $banking_model->getTransactions('deposit', store_id(), 3)) : ?>
                            <?php foreach ($transactions as $row) : ?>
                              <tr>
                                ...
                                <td class="w-45"><a class="view-deposit" data-refno="<?php echo $row['ref_no'];?>" href="#"><?php echo $row['title'];?></a></td>
                  ...
                  <div class="box-footer clearfix text-center">
                    <?php if (user_group_id() == 1 || has_permission('access', 'read_bank_transactions')) : ?>
                      <a href="<?php echo root_url().ADMINDIRNAME;?>/bank_transactions.php"><?php echo trans('button_view_all'); ?> &rarr;</a>
                    <?php endif; ?>
                  </div>
                </div>
              </div>
                        ...
                        <tbody>
                          <?php if ($transactions = $banking_model->getTransactions('withdraw', store_id(), 3)) : ?>
                            <?php foreach ($transactions as $row) : ?>
                              <tr>
                                <td class="w-35 text-center"><?php echo $row['created_at'];?></td>
                                <td class="w-45"><a class="view-withdraw tran-ref-title" data-refno="<?php echo $row['ref_no'];?>" href="#" ><?php echo $row['title'];?></a></td>
                                <td class="w-20 text-right"><?php echo currency_format($row['amount']);?></td>
                              </tr>
                            <?php endforeach; ?>
                          <?php endif; ?>
