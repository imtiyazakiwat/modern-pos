...
<div class="content-wrapper" ng-controller="StoreActionController">
	...
	<section class="content">
			...
			<div class="box box-success box-no-border">
				<div class="nav-tabs-custom">
					...
					<div class="tab-pane<?php echo $tab_active == 'email-setting' ? ' active' : null;?>" id="email-setting">
						<div class="form-group">
							<label for="email_from" class="col-sm-3 control-label">
						...
						<div class="form-group">
							<label for="email_address" class="col-sm-3 control-label">
						...
						<div class="form-group">
							<label for="email_driver" class="col-sm-3 control-label">
						...
						<div ng-show="isSendMail" class="form-group">
							<label for="send_mail_path" class="col-sm-3 control-label">
							...
							<div class="col-sm-7">
			              		<input type="text" class="form-control" id="send_mail_path" value="" name="preference[send_mail_path]">
							</div>
						</div>
						...
						<div ng-show="isSMTP" class="form-group">
							<label for="smtp_username" class="col-sm-3 control-label">
						...
						<div ng-show="isSMTP" class="form-group">
							<label for="ssl_tls" class="col-sm-3 control-label">
					...
					<div class="tab-pane<?php echo $tab_active == 'general' ? ' ftp-setting' : null;?>" id="ftp-setting">
						<div class="form-group">
							<label for="ftp_hostname" class="col-sm-3 control-label">
						...
						<div class="form-group">
							<label for="ftp_username" class="col-sm-3 control-label">
						...
						<div class="form-group">
							<label for="ftp_password" class="col-sm-3 control-label">
		...
		<div id="cronjob" class="alert alert-info br-0">
