  ...
  <section class="content">
    ...
    <article class="app-layout">
      <div class="app-container">
        <div class="app-row">
          <header class="app-header action-wrapper"">
          ...
          <main class="app-col app-content">
            ...
            <div class="table-responsive">  
              ...
              ?> 
              <table id="language-language-list" class="table table-bordered table-striped table-hover lang-list-wrapper" data-hide-colums="<?php echo $hide_colums; ?>">
                <thead>
                  <tr class="bg-gray">
                    <th class="w-25">
